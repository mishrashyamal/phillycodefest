...
def perdict_person():
    ...
    l5=Label(top, text="Would you say you are someone who is open to new opportunities and willing to take risks", foreground='white', bg='black').place(x=70, y=250)
    l5=Label(top, text="Do you tend to stick with familiar activities and routines?", foreground='white', bg='black').place(x=70, y=250)
    ...
    # openness_value = 1 if openness_str == "very strongly disagree" else (2 if openness_str == "disagree" else (3 if openness_str == "neutral" else (4 if openness_str == "agree" else 5)))
    # neuroticism_str = neuroticism.get().split("-")[0]
    # neuroticism_value = 1 if neuroticism_str == "very strongly disagree" else (2 if neuroticism_str == "disagree" else (3 if neuroticism_str == "neutral" else (4 if neuroticism_str == "agree" else 5)))
    # conscientiousness_str = conscientiousness.get().split("-")[0]
    # conscientiousness_value = 1 if conscientiousness_str == "very strongly disagree" else (2 if conscientiousness_str == "disagree" else (3 if conscientiousness_str == "neutral" else (4 if conscientiousness_str == "agree" else 5)))
    # agreeableness_str = agreeableness.get().split("-")[0]
    # agreeableness_value = 1 if agreeableness_str == "very strongly disagree" else (2 if agreeableness_str == "disagree" else (3 if agreeableness_str == "neutral" else (4 if agreeableness_str == "agree" else 5)))
    # extraversion_str = extraversion.get().split("-")[0]
    # extraversion_value = 1 if extraversion_str == "very strongly disagree" else (2 if extraversion_str == "disagree" else (3 if extraversion_str == "neutral" else (4 if extraversion_str == "agree" else 5)))
